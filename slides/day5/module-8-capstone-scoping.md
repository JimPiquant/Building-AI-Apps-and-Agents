...
eyebrow: DAY 5 · MODULE 8 · 60 MIN
tag: Day 5 · Module 8
deck: module-8-capstone-scoping.pptx
---
...
<!-- notes: Start the 60-minute timer immediately; this title consumes no separate lecture block. Workshop outcome: each team leaves with a charter and five-layer sketch, explicit evidence to collect, and owners for unresolved dependencies. A completed lab or functioning agent is not required. Jim circulates from minute zero rather than postponing all review until the final eight minutes. -->

- Define · sketch · measure · challenge · record the disposition

## 00:00–10:00 · Narrow the scenario
<!-- layout: list -->
<!-- source: docs/day5-plan.md -->
<!-- notes: Facilitate, do not lecture. Ask each team for one sentence in the form “For [user], help with [bounded task] so that [observable outcome].” Then force one explicit non-goal. Capture skills, environment, data, quota, or permission gaps as owned dependencies; no prior lab or environment is required today. Checkpoint at minute 10: problem, user, in-scope task, and non-goals are written. -->
...
<!-- notes: The five-layer sketch is a workshop organizing lens, not Microsoft Foundry product architecture and not five Azure resources. Map each row to the real component or service the team expects to use, then mark identity/data/trust boundaries. Official Foundry architecture instead distinguishes the Foundry resource, projects, project assets, and independently governed connected Azure services. Checkpoint at minute 22: every layer has a component or an explicit not-applicable rationale and at least one trust boundary is marked. -->
...
## 22:00–32:00 · Write criteria, not tasks
<!-- layout: compare -->
...
<!-- notes: A task says what to implement; a success criterion says what observable evidence must meet which acceptance rule. Challenge “improve answer quality” by asking for cases, expected behavior, evaluator or human check, threshold, boundary, and evidence owner. Teams need 3–5 criteria and at least 10 planned golden-set cases. Thresholds are team decisions, not Microsoft defaults. Checkpoint at minute 32: each criterion names a metric or observation, unit where relevant, case boundary, acceptance rule, evidence, and owner. -->
...
## 42:00–60:00 · Challenge, coach, and record disposition
<!-- layout: list -->
...
<!-- notes: A failure case is a test condition, such as an unauthorized lookup or unsupported question. A control is the deliberately implemented behavior, such as deny, answer only from evidence, or route to an application-owned review path. Do not infer that a drawn control works. Minutes 42–52: peers challenge one failure path and one cost or permission risk. Minutes 52–60: record ready, changes required, or needs review; every gap gets an owner, evidence request, status, and next action. Jim has coached throughout. An unresolved charter must remain explicitly unresolved rather than being counted as approved. -->

- **42:00–52:00 · Failure path** — Choose one failure case, its control, enforcement point, expected outcome, and verifying evidence
- **42:00–52:00 · Risk check** — Challenge one permission or cost/latency assumption; name its owner and smallest test
- **52:00–60:00 · Review** — Record `Reviewed—ready`, `Reviewed—changes required`, or `Needs review`
- **52:00–60:00 · Close gaps** — Give every open item a status, owner, evidence request, and next action
