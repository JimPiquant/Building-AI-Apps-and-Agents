...
Environment variables:
    ...
    AZURE_EXPERIMENTAL_ENABLE_GENAI_TRACING="true" - See https://learn.microsoft.com/en-us/azure/foundry/observability/how-to/trace-agent-client-side?tabs=python%2Ccustom-attributes-python#enable-genai-tracing 
"""
