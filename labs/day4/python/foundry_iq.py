"""Shared Foundry IQ MCP integration for the Day 4 lab.

Copied from labs/day2/python/foundry_iq.py, unchanged apart from this
docstring — reuses the SAME Foundry IQ knowledge base you already created
in the Foundry portal for Day 2. See
labs/day2/README.md#prerequisites-portal-setup-one-time-15-min for how it
was provisioned; there is nothing new to set up here.
